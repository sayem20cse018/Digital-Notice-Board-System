  ...
  return (
    <div className="space-y-6">
      <AdminPageHeader
        ...
        subtitle="Upload the exam schedule — QR code is generated server-side with the correct public URL so phones can scan it."
      />
          ...
          <div className="flex flex-wrap items-start gap-6">
            ...
            {qrCodeUrl ? (
              <div className="relative h-32 w-32 flex-shrink-0 overflow-hidden rounded-lg border bg-white p-1 shadow">
                <Image src={qrCodeUrl} alt="Exam Routine QR" fill className="object-contain" unoptimized />
              </div>
            ) : (
        ...
        <AdminFormCard title={data.id ? "Update Exam Routine" : "Setup Exam Routine"}>
          <form key={formKey} onSubmit={handleSubmit} className="max-w-lg space-y-4">
            ...
            <div className="rounded-lg border-2 border-blue-200 bg-blue-50 p-4 space-y-3">
              <p className="text-sm font-semibold text-blue-800">Upload Exam Routine File — QR is generated server-side on save</p>
              <FileUpload
                name="fileUrl"
                label="Exam Routine File (PDF or Image)"
